...
export function Home() {
    return (
        <section className={style.wrap}>
            {/* <video src="https://ak.picdn.net/shutterstock/videos/1055814122/preview/stock-footage-rostov-on-don-russia-july-hands-flipping-comic-book-pages-comics-background-k.webm" muted loop autoPlay></video>
            <div className={style.textContainer}>
                <h2 className={style.header}><span>MARVEL</span>SUPERHEROES</h2>
            </div>
            <div>
